...
function winState(state){
    let textStat = " The word was : ";
    switch(state){
        case true : 
            stat.innerText = "GG!"+textStat;
            break;
        case false :
            stat.innerText = "Sad..."+textStat;
            break;
    }
    aword.innerText = chosenWord.toUpperCase();
    aword.setAttribute("href","https://www.dictionary.com/browse/"+chosenWord);
    aword.setAttribute("target","_blank");
    stat.style.visibility = "visible";
    aword.style.visibility = "visible";
}
...
function checkWord(){   //////////handle view change/////////////////////////////////////////////////////
    ...
    for(let i=0; i<wordLength; i++){
        if(typedWord.charAt(i) === chosenWord.charAt(i)){
            ...
            col.style.boxShadow = "0px 0px 0px 1px rgb(0, 80, 0)";
            ...
            for(idx of indexes){
                ...
                col.style.boxShadow = "0px 0px 0px 1px rgb(150, 40, 0)";
...
document.addEventListener("DOMContentLoaded", function(e){  //to wait for DOM to load
    ...
    aword = document.getElementById('word');
